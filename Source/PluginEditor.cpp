...
{
    g.fillAll(juce::Colours::darkgrey);  // Change this color to suit your theme

    g.setColour(juce::Colours::white);  // Set the drawing color to white for labels and sliders
    g.drawRect(getLocalBounds(), 1);  // Draw a border around the editor (optional)
}
...
void GuitarControllerAudioProcessorEditor::sliderValueChanged(juce::Slider* slider)
{
